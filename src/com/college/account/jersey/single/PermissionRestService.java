...
public class PermissionRestService {
	...
	private static DaoPermissionService p = ServiceFactoryBean.getPermissionService();
    private static final Logger log = Logger4j.getLogger(PermissionRestService.class);
