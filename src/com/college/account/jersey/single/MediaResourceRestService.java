...
{
    private static DaoMediaResourceService p = ServiceFactoryBean.getMediaResourceService();
    private static final Logger log = Logger4j.getLogger(MediaResourceRestService.class);
    ...
    public String save(String jsonString){
        ...
        return Cause.getFailcode(22000, "", "system error");
    }
