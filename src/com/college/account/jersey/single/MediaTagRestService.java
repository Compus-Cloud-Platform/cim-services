...
@Path("/mediatags")
public class MediaTagRestService
{
    private static DaoMediaTagService p = ServiceFactoryBean.getMediaTagService();
    private static final Logger log = Logger4j.getLogger(MediaTagRestService.class);
    ...
    public String save(String jsonString){
        ...
        return Cause.getFailcode(23000, "", "system error");
    }
