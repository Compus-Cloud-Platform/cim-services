...
@Path("/mediacategorys")
public class MediaCategoryRestService
{
    private static DaoMediaCategoryService p = ServiceFactoryBean.getMediaCategoryService();
    private static final Logger log = Logger4j.getLogger(MediaCategoryRestService.class);
    ...
    public String save(String jsonString){
        ...
        return Cause.getFailcode(21000, "", "system error");
    }
